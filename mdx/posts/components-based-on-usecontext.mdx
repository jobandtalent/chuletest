---
title: 'How to test components based on useContext'
excerpt: 'Let’s take a look at how to test a react component that is dependent on useContext hook. In the way, we will learn the famous Compound Component pattern used in the most of UI libraries these days.'
coverImage: '/images/dots.png'
coverImageAlt: 'Connecting dots'
date: '2021-04-20'
---
...
Following our frontend architecture conventions, we have a folder with:

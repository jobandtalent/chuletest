---
title: 'Mocking APIs with MirageJS'
excerpt: 'We ignored the network for too long. Normally we mock up the request responses, adding hacks and obtuse code to solve asynchronous processes. Using [MirageJS](https://miragejs.com/) we solve this.'
date: '2021-04-27'
draft: true
---
...
createServer({
  ...
  seeds(server) {
    server.create("todos", "Publish chuletest")
